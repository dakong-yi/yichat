...
import 'package:yichat/src/pages/cross_platform/wide_screen/about_us.dart';
import 'package:yichat/src/pages/cross_platform/wide_screen/contact_us.dart';
import 'package:yichat/src/pages/cross_platform/wide_screen/settings.dart';
        ...
        GestureDetector(
          onTapDown: (details) {
            TUIKitWidePopup.showPopupWindow(
                ...
                operationKey:
                    TUIKitWideModalOperationKey.secondaryClickUserAvatar,
                borderRadius: const BorderRadius.all(Radius.circular(4)),
                context: context,
                offset: Offset(details.globalPosition.dx + 10,
                      ...
                      data: [
                        ...
                        ColumnMenuItem(
                            ...
                            onClick: () {
                              ...
                              TUIKitWidePopup.showPopupWindow(
                                  operationKey:
                                      TUIKitWideModalOperationKey.aboutUs,
                                  context: context,
                                  theme: theme,
                                  title: TIM_t("关于我们"),
                                  width:
                        ...
                        ColumnMenuItem(
                            ...
                            onClick: () {
                              ...
                              TUIKitWidePopup.showPopupWindow(
                                  operationKey:
                                      TUIKitWideModalOperationKey.settings,
                                  context: context,
                                  theme: theme,
                                  title: TIM_t("设置"),
                                  width:
                        ...
                        ColumnMenuItem(
                            ...
                            onClick: () {
                              ...
                              launchUrl(
                                Uri.parse(
                                    "https://wj.qq.com/s2/11858997/6b56/"),
